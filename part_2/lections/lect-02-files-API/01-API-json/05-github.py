...
# res_json = list(filter(lambda x: x['language']=='JavaScript', res_json))
res_json = list(filter(lambda x: not(x['language'] is None), res_json))
res_json.sort(key=lambda x: x['language'])
